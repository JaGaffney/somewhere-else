...
export const NonSkillPanel = (props) => {
    ...
    return (
        <div className="sidepanel__skill">
            ...
            <button className="skillpanel" onClick={() => props.setActivePage("inventory")}>
                <img className="skillpanel__icon" src={require("../../images/sidepanel/equipment.svg")} />
                <span className={`skillpanel__name ${props.activePage === "inventory" ? "skillpanel__name-active" : null}`}>Inventory</span>
            </button>
