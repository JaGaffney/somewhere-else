...
export const itemSeed = [
  ...
  },
  {
    ...
    description: "A iron shield",
    rarity: "COMMON",
    requirementLevel: 1,
    slot: Slot.OFF_HAND,
    equipmentStats: { defence: 4, weight: 10 },
    effect: "",
  },
  {
    id: 47,
...

  {
    ...
    description: "A dagger forged from mithril",
    rarity: "COMMON",
    requirementLevel: 40,
    slot: Slot.MAIN_HAND,
    equipmentStats: {
