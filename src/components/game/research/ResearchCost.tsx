        ...
        props.activeResearch ?
            (
                <div className="research__singleItem">
                    <button disabled={!props.validatePurchase(props.activeResearch.cost, 1)} className="generic__button generic__button-fit generic__button-primary" onClick={() => props.onBuyHandler(props.activeResearch, 1, "singular", props.setActiveResearch)}>Purchase</button>
